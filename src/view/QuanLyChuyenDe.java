...
//    }
    private void delete() {
        String maCD = txtMaCD.getText();
        if (DialogHelper.confirm(this, "Bạn có muốn xóa chuyên đề này ?")) {
            try {
                if (!dao.delete(maCD)) {
                    DialogHelper.confirm(this, "Chuyên Đề đã tồn tại Khóa Học\n Bạn có muốn chuyển hướng đến trang Khóa Học ?");
